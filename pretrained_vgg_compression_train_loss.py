...
def main():
    ...
    with open("pretrained_train_Acc1"+"_"+str(args.epochs)+"_"+str(args.insertion_place)+"_"+str(args.embedding_dim)+"_"+str(args.num_embeddings)+"_"+str(args.weight)+"_"+str(args.learning_rate)+".txt", "wb") as fp:   #Pickling
        pickle.dump(train_epochs_Acc1, fp)
    with open("pretrained_train_Acc5"+"_"+str(args.epochs)+"_"+str(args.insertion_place)+"_"+str(args.embedding_dim)+"_"+str(args.num_embeddings)+"_"+str(args.weight)+"_"+str(args.learning_rate)+".txt", "wb") as fp:   #Pickling
