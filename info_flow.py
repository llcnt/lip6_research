...
def main():
    ...
    with open("epochs_train_res_recon_error"+"_"+str(args.epochs)+"_"+str(args.insertion_place)+"_"+str(args.embedding_dim)+"_"+str(args.num_embeddings)+".txt", "wb") as fp:   #Pickling
        pickle.dump(epochs_train_res_recon_error, fp)
    with open("epochs_train_res_perplexity"+"_"+str(args.epochs)+"_"+str(args.insertion_place)+"_"+str(args.embedding_dim)+"_"+str(args.num_embeddings)+".txt", "wb") as fp:   #Pickling
        pickle.dump(epochs_train_res_perplexity, fp)
    with open("epochs_train_res_classif_loss"+"_"+str(args.epochs)+"_"+str(args.insertion_place)+"_"+str(args.embedding_dim)+"_"+str(args.num_embeddings)+".txt", "wb") as fp:   #Pickling
        pickle.dump(epochs_train_res_classif_loss, fp)
    with open("epochs_Acc1"+"_"+str(args.epochs)+"_"+str(args.insertion_place)+"_"+str(args.embedding_dim)+"_"+str(args.num_embeddings)+".txt", "wb") as fp:   #Pickling
        pickle.dump(epochs_Acc1, fp)
    with open("epochs_Acc5"+"_"+str(args.epochs)+"_"+str(args.insertion_place)+"_"+str(args.embedding_dim)+"_"+str(args.num_embeddings)+".txt", "wb") as fp:   #Pickling
