...
class VectorQuantizerEMA(nn.Module):
    ...
    def forward(self, inputs):
        ...
        # e_latent_loss = torch.norm(quantized.detach() - inputs, p=2) / torch.norm(inputs, p=2)
...
def main():
    ...
    (images0, target0) = next(iter(training_loader))

    
    for epoch in range(args.epochs):
        
        (images, target) = (images0, target0)
        ...
        # (images, target) = next(iter(training_loader))
        ...
        recon_error2 = torch.norm(data_recon - data_before, p=2)
        # recon_error = torch.norm(data_recon - data_before, p=2) / torch.norm(data_recon, p=2)

        print(torch.norm(data_before, p=2).item())
        print(torch.norm(data_recon, p=2).item())
        print(recon_error2.item())
    ...
    with open("bias_train_res_recon_error"+"_"+str(args.epochs)+"_"+str(args.insertion_place)+"_"+str(args.embedding_dim)+"_"+str(args.num_embeddings)+"_"+str(args.weight)+"_"+str(args.learning_rate)+".txt", "wb") as fp:   #Pickling
        pickle.dump(epochs_train_res_recon_error, fp)
    with open("bias_train_res_perplexity"+"_"+str(args.epochs)+"_"+str(args.insertion_place)+"_"+str(args.embedding_dim)+"_"+str(args.num_embeddings)+"_"+str(args.weight)+"_"+str(args.learning_rate)+".txt", "wb") as fp:   #Pickling
        pickle.dump(epochs_train_res_perplexity, fp)
    with open("bias_train_res_classif_loss"+"_"+str(args.epochs)+"_"+str(args.insertion_place)+"_"+str(args.embedding_dim)+"_"+str(args.num_embeddings)+"_"+str(args.weight)+"_"+str(args.learning_rate)+".txt", "wb") as fp:   #Pickling
        pickle.dump(epochs_train_res_classif_loss, fp)
    with open("bias_train_res_vq_loss"+"_"+str(args.epochs)+"_"+str(args.insertion_place)+"_"+str(args.embedding_dim)+"_"+str(args.num_embeddings)+"_"+str(args.weight)+"_"+str(args.learning_rate)+".txt", "wb") as fp:   #Pickling
        pickle.dump(epochs_train_res_vq_loss, fp)
    with open("bias_Acc1"+"_"+str(args.epochs)+"_"+str(args.insertion_place)+"_"+str(args.embedding_dim)+"_"+str(args.num_embeddings)+"_"+str(args.weight)+"_"+str(args.learning_rate)+".txt", "wb") as fp:   #Pickling
        pickle.dump(epochs_Acc1, fp)
    with open("bias_Acc5"+"_"+str(args.epochs)+"_"+str(args.insertion_place)+"_"+str(args.embedding_dim)+"_"+str(args.num_embeddings)+"_"+str(args.weight)+"_"+str(args.learning_rate)+".txt", "wb") as fp:   #Pickling
        pickle.dump(epochs_Acc5, fp)
    with open("bias_train_Acc1"+"_"+str(args.epochs)+"_"+str(args.insertion_place)+"_"+str(args.embedding_dim)+"_"+str(args.num_embeddings)+"_"+str(args.weight)+"_"+str(args.learning_rate)+".txt", "wb") as fp:   #Pickling
        pickle.dump(train_epochs_Acc1, fp)
    with open("bias_train_Acc5"+"_"+str(args.epochs)+"_"+str(args.insertion_place)+"_"+str(args.embedding_dim)+"_"+str(args.num_embeddings)+"_"+str(args.weight)+"_"+str(args.learning_rate)+".txt", "wb") as fp:   #Pickling
